...
# img.show()
myString=ImageToString("lena-64x64.jpg")
print(len(myString))
with open("inputthumb1.txt", "w") as tfile:
    tfile.write(myString)

my2ndstring= ImageToString("Martin_Berggren.gif")
print(len(my2ndstring))
with open("inputthumb2.txt", "w") as t1file:
    t1file.write(my2ndstring)
